...
public class PaymentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String amount_raw[] = request.getParameter("amount").split(",");
        String a = "";
        for (int i = 0; i < amount_raw.length; i++) {
            a += amount_raw[i];
        }
...
//Receive information from "vnpay_pay.jsp" and Class "controller.Config" to make a Payment URL sending backward "vnpay_pay.jsp" for AJAX processing
