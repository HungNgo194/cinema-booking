<%-- 
   Document   : userWeb-page
   Created on : Jan 28, 2024, 11:07:00 AM
   Author     : Admin
--%>
...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/c6a29e1bb1.js" crossorigin="anonymous"></script>
                                ...
                                <div class="header__auth">
                                    ...
                                    <div class="header__auth">
                                        <button class="header__search-btn" type="button">
                                            <i class="dropdown-menu icon ion-ios-search"></i>
                                        ...
                                        <a  class="">
                                            <button><i style=" border-radius: 100px/100px;
                                                       background: white;
                                                       padding: 20px; " 
                                    ...
                                    <div class="card__content">
                                        <form action="./LoadMovieServlet" method="POST">
                                            ...
                                            <c:forEach items="${movies}" var="movie">
                                                <table>
                                                    <tr>
                                                        <td><h3 class="card__title"><input readonly="readonly" type="text" name="movieName" value="${movie.movieName}" style=" font-size: larger;
                                                                                           border: none;
                                                                                           background-color: transparent;
                                                                                           outline: none; 
                                                                                           color: inherit;
                                                                                           width: 65px; 
                                                                                           cursor: default; "></h3></td>
                                                    </tr>
                                                </table>
                                            </c:forEach>
                            ...
                            <div class="item">
                                ...
                                <div class="card card--big">
                                    ...
                                    <div class="card__content">
                                        ...
                                        <button type="submit" ><a href="booking.jsp">Dat ve</a></button>
                                        <span class="card__category">
                                            <a href="#">Comedy</a>
                                        </span>
